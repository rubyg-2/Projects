...
public class UserNameRecognizer {
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 2: 
				// State 2 deals with a character after either a period or minus sign or underscore in the name.
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period or minus sign or underscore must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
