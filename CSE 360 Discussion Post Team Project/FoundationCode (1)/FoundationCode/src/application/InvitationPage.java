...
public class InvitationPage {
    ...
    public void show(DatabaseHelper databaseHelper,Stage primaryStage) {
        ...
        Label goToAdminHomeLabel = new Label(""); ;
        goToAdminHomeLabel.setStyle("-fx-font-size: 14px; -fx-font-style: italic;");
        
        //for going back to admin home from invitation page
        Button goToAdminHome = new Button("Admin Home");
        ...
        goToAdminHome.setOnAction(a -> {
        	
        	new AdminHomePage().show(primaryStage,databaseHelper);
        });
	    

        layout.getChildren().addAll(userLabel, showCodeButton, inviteCodeLabel, goToAdminHome);
